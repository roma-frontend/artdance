/** Карточка ссылки на приглашение сдавать зал. Содержимое — `lib/seo/og-section-image.tsx`. */
...
export default sectionOgImage('listYourStudio', getContentHero('listYourStudio'));
