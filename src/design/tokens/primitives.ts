...
/**
 * Crimson — брендовый акцент. Значения ровно те, что в утверждённом макете:
 *  400 `#6E1422` — «signal» (живая доступность, urgency, alert)
 ...
 *
 * Светлых (розовых) шагов в рампе нет — решение заказчика: акцент один и тот же
 * бургунди на любом фоне, как в прототипе, где `--accent` объявлен в `:root` и в
 * тёмной теме не переопределяется. Шаги 300 и 350 существуют только как имена
 * для текстовых ролей тёмной темы и держат тот же бургунди.
 */
