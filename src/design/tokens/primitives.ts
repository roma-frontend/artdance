...
/**
 * Crimson — брендовый акцент. Рампа связывает три значения из гайдов:
 *  400 `#D6162B` — «signal red» (живая доступность, urgency, alert)
 *  600 `#8B1A2B` — интерактивный акцент прототипа (CTA, active nav)
 *  700 `#6E0F1C` — burgundy для полноэкранных кинематографичных секций
 */
